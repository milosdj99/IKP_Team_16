...
int GetHashValueProcess(int key, int size) {
...
void HashInsertOrUpdateProcess(int key, int value, int* HashArray) {
...
int HashSearchProcess(int key, int* HashArray) {
